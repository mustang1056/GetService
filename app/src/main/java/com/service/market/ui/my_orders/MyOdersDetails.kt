...
@Composable
fun MyOrderDetails(movieItem: MyOrders, navController: NavController
){
    Scaffold(
        ...
        Column(
            ...
            MyRemontDetailsBanner(movieItem = movieItem)

                Column(
                    modifier = Modifier.padding(1.dp)
                ) {

                    MyRemontDetailsText(movieItem = movieItem)
                }
...
@Composable
fun MyRemontDetailsBanner(movieItem: MyOrders){
    /*
...
fun ProfileProperty(label: String, value: String, isLink: Boolean = false) {
    ...
    Column(modifier = Modifier.padding(start = 10.dp, end = 16.dp, bottom = 10.dp)) {
        ...
        Divider(Modifier.padding(top = 1.dp, bottom = 1.dp),color = Color.Black)
...
@Composable
fun MyRemontDetailsText(movieItem: MyOrders){
    ...
    Column(
        ...
        Column(modifier = Modifier
            ...
            com.service.market.ui.order.ProfileProperty("Категория", movieItem.service_title, false)
            Divider(Modifier.padding(top = 1.dp, bottom = 1.dp),color = colorResource(R.color.gray))
            com.service.market.ui.order.ProfileProperty("Описание", movieItem.title, false)
            Divider(Modifier.padding(top = 1.dp, bottom = 1.dp),color = colorResource(R.color.gray))
            com.service.market.ui.order.ProfileProperty("Комментарий", movieItem.comment, false)
            Divider(Modifier.padding(top = 1.dp, bottom = 1.dp),color = colorResource(R.color.gray))
            com.service.market.ui.order.ProfileProperty(
                "Стоймость",
                movieItem.cost.toString(),
                false
            )
